...
export const projects: Project[] = [
  {
    ...
    repo: "https://github.com/Naufall1",
  ...
  },
  {
    ...
    subtitle: "Headless CMS & API Layer",
    description:
      "The engine behind this portfolio — a headless backend serving content, analytics and contact pipelines. Rate-limited, cached at the edge, and deployed as containerized microservices on cloud infrastructure.",
...
export const socials = {
  email: "mailto:naufalananta@example.com",
  github: "https://github.com/Naufall1",
